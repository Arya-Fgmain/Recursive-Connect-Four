...
public class Sys {
  ...
  private boolean checkSlots(Slot slot1, Slot slot2, Slot slot3, Slot slot4) {
  ...
  public boolean CheckRightDig(int startR, int startC) {
    ...
    if ( (startR >= GRID_ROW || startR < 0) || ( (startC >= GRID_COL || startC < 0) ) ) { // Only checks if dimensions are valid
      return false;
    }
