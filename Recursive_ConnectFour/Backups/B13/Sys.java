...
public class Sys {
  ...
  private boolean isGroupExist(Slot slot1, Slot slot2, Slot slot3, Slot slot4) {
  ...
  private boolean rightDigCheck(int startR, int startC) {
    ...
    if (this.isGroupExist(this.grid[startR][startC], this.grid[startR - 1][startC+1], this.grid[startR - 2][startC + 2], this.grid[startR - 3][startC + 3])) {
      // Storing values of slots to check them
      if (this.isSlotsEqual(this.grid[startR][startC], this.grid[startR - 1][startC+1], this.grid[startR - 2][startC + 2], this.grid[startR - 3][startC + 3])) {
        return true;
      }
    }
  ...
  private boolean rowCheck(int R, int startC) {
    ...
    if (this.isGroupExist(this.grid[R][startC], this.grid[R][startC + 1], this.grid[R][startC + 2], this.grid[R][startC + 3])) {
      // Checks the given column
      // and the three coming after it
      if (this.isSlotsEqual(this.grid[R][startC], this.grid[R][startC + 1], this.grid[R][startC + 2], this.grid[R][startC + 3])) {
        return true;
      }
    }
  ...
  private boolean colCheck(int startR, int C) {
    ...
    if (this.isGroupExist(this.grid[startR][C], this.grid[startR + 1][C], this.grid[startR + 2][C], this.grid[startR + 3][C])) {
      if (this.isSlotsEqual(this.grid[startR][C], this.grid[startR + 1][C], this.grid[startR + 2][C], this.grid[startR + 3][C])) {
        return true;
      }
    }
